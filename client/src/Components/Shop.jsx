...
export default function Shop() {
    ...
    function postSeach(e) {
        ...
        setProducts(allProductStateData.filter((item) => item.name.toLowerCase().includes(searchTerm) || item.maincategory.toLowerCase() === searchTerm || item.subcategory.toLowerCase() === searchTerm || item.brand.toLowerCase() === searchTerm || item.color.toLowerCase() === searchTerm || item.description.toLowerCase().includes(searchTerm)))
    }
    ...
    function postPriceFilter(e) {
        ...
        if (mc === "All" && sc === "All" && br === "All")
            ...
            p = allProductStateData.filter((item) => item.subcategory === sc && item.brand === br)
        else
    ...
    function filterProducts(mc, sc, br) {
        if (mc === "All" && sc === "All" && br === "All")
            ...
            setProducts(allProductStateData.filter((item) => item.maincategory === mc))
        else if (mc === "All" && sc !== "All" && br === "All")
            setProducts(allProductStateData.filter((item) => item.subcategory === sc))
        else if (mc === "All" && sc === "All" && br !== "All")
            setProducts(allProductStateData.filter((item) => item.brand === br))
        else if (mc !== "All" && sc !== "All" && br === "All")
            setProducts(allProductStateData.filter((item) => item.maincategory === mc && item.subcategory === sc))
        else if (mc !== "All" && sc === "All" && br !== "All")
            setProducts(allProductStateData.filter((item) => item.maincategory === mc && item.brand === br))
        else if (mc === "All" && sc !== "All" && br !== "All")
            setProducts(allProductStateData.filter((item) => item.subcategory === sc && item.brand === br))
        else
            setProducts(allProductStateData.filter((item) => item.maincategory === mc && item.subcategory === sc && item.brand === br))
    }
